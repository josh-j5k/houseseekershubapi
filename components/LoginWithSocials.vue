...
<template>
    ...
    <div class="pb-12 flex flex-col gap-4 justify-center items-center">
        <span v-if="loading">
            <i class="fa-solid fa-spinner spinner"></i>
        </span>
        <button @click="handleOauth2" :disabled="loading"
            class="border mx-auto w-56 h-10 text-gray-800 flex gap-3 justify-center rounded items-center">
            <span class="text-lg">
                <svg class="w-5 h-5" viewBox="-3 0 262 262" version="1.1" xmlns="http://www.w3.org/2000/svg"
